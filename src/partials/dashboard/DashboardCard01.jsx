...
function DashboardCard01() {
  ...
  const chartData = {
    ...
    datasets: [
      // Indigo line
      {
        data: [37200, 38150, 38980, 40240, 39720, 41580, 42960, 42140, 43890, 45210, 44650, 46320, 47180, 46840, 48620, 50130, 49380, 51240, 52680, 51910, 53760, 53120, 54680, 54190, 55240, 55429],
        fill: true,
